        ...
        return Book::query()
            ...
            ->selectRaw("
                CASE
                    ...
                    AND discount.discount_end_date < :currentDate
                    OR discount.discount_start_date > :currentDate
                    THEN book.book_price

                    WHEN discount.discount_price IS NOT NULL
                    AND discount.discount_start_date <= :currentDate
                    THEN discount.discount_price

                    END
                AS final_price", array('currentDate' => $currentDate));
    }
}
